...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Assets\\Files\\GuidePhoto";//path for storing image
                            Random r = new Random();//to generate random number
                            int r_num = r.nextInt(1111) + 999;//values between this are generated

                            photo = "file_photo" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                        ...
                        if (field_name.equals("file_proof"))//write the name of image here it is img_product
                        {
                            ...
                            proof = "list_proof" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                           //creating a file object
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_guide(guide_name,guide_email,guide_contact,guide_photo,guide_proof,guide_password,guide_doj)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + photo + "','" + proof + "','" + value[3] + "',curdate())";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/GuideRegistration.jsp';
        ...
        <%
            ...
            setTimeout(function() {
                //window.location.href = '../../Guest/user.jsp';
            }, 40);//40millisecend it go to next page
        </script>
                    <%
                }

...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file_logo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\LangLogo\\";//path for storing image
                            Random r = new Random();//to generate random number
                            int r_num = r.nextInt(1111) + 999;//values between this are generated

                            photo = "LangLogo" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
...
//                        }
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_subs(sub_name,sub_logo,sub_language,sub_duration,sub_details,sub_amount)values('" + value[0] + "','" + photo + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "')";
   ...
   System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/Subscriptions.jsp';

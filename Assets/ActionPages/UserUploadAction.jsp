...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "UserPhoto" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
...
//                        }
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_user(user_name,user_email,user_contact,user_photo,user_password)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + photo + "','" + value[3] + "')";

/*!main.js | Friendkit | © Css Ninja. 2019-2020*/"use strict";
var env = "development";
initPageloader(), $(document).ready((function() {
    "development" === env && (changeDemoHrefs(), changeDemoImages());
    var e = document.querySelectorAll("[data-lazy-load]"), i = lozad(e, {loaded: function(e) {
            e.parentNode.classList.add("loaded")
        }});
    i.observe(), $(".demo-link a").on("click", (function(e) {
        e.preventDefault();

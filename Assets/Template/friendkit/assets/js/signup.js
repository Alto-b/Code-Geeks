"use strict";
/*!signup.js | Friendkit | © Css Ninja. 2019-2020*/Dropzone.autoDiscover = !1, $(document).ready((function() {
    if ($(".progress-wrap .dot").on("click", (function() {
        ...
        var e = new Dropzone("#profile-pic-dz", {maxFilesize: 8, acceptedFiles: ".jpeg,.jpg,.png", clickable: ".upload-button", init: function() {
                ...
                a.style.position = "absolute", a.style.right = "10px", a.style.bottom = "10px", a.style.zIndex = 9999, a.textContent = "Crop", a.classList.add("button"), s.appendChild(a), a.addEventListener("click", (function() {
                    n.getCroppedCanvas({width: 256, height: 256}).toBlob((function(s) {
                        e.createThumbnail(s, e.options.thumbnailWidth, e.options.thumbnailHeight, e.options.thumbnailMethod, !1, (function(a) {
                            ...
                            o.onload = function(e) {
                                document.getElementById("convertedImage").value = s.dataURL;
                                $("#upload-preview").attr("src", s.dataURL), $(".picture-container").webuiPopover({title: "", content: 'Your photo is ready to be uploaded. Hit the "Save Changes" button to complete the upload process.', animation: "pop", width: 300, style: "inverse", placement: "top", offsetTop: -16}).trigger("click")
                            }, o.readAsDataURL(t)
                        }));

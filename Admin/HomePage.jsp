...
<head>
  ...
  <link rel="stylesheet" href="../Assets/Template/skydash/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" type="text/css" href="../Assets/Template/skydash/js/select.dataTables.min.css">
...
<body>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="../Assets/Template/skydash/#" data-toggle="dropdown">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="../Assets/Template/skydash/#" data-toggle="dropdown" id="profileDropdown">
          ...
          <li class="nav-item nav-settings d-none d-lg-flex">
            <a class="nav-link" href="../Assets/Template/skydash/#">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div id="right-sidebar" class="settings-panel">
        ...
        <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-toggle="tab" href="../Assets/Template/skydash/#todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">TO DO LIST</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="chats-tab" data-toggle="tab" href="../Assets/Template/skydash/#chats-section" role="tab" aria-controls="chats-section">CHATS</a>
          </li>
        </ul>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#ui-basic" aria-expanded="false" aria-controls="ui-basic">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#form-elements" aria-expanded="false" aria-controls="form-elements">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#charts" aria-expanded="false" aria-controls="charts">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#tables" aria-expanded="false" aria-controls="tables">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#icons" aria-expanded="false" aria-controls="icons">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#auth" aria-expanded="false" aria-controls="auth">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="../Assets/Template/skydash/#error" aria-expanded="false" aria-controls="error">
  ...
  <script src="../Assets/Template/skydash/js/dataTables.select.min.js"></script>
  ...
  <script src="../Assets/Template/skydash/js/dashboard.js"></script>

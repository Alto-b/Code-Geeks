    ...
    <jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
        ...
        <%
            ...
            if (request.getParameter("btn_submit") != null) {
                ...
                String selQry3 = "select * from tbl_admin where admin_email='" + request.getParameter("txt_name") + "' and admin_password='" + request.getParameter("txt_password") + "'";
                ResultSet rs3 = con.selectCommand(selQry3);

                String selQry1 = "select * from tbl_guide where guide_email='" + request.getParameter("txt_name") + "' and guide_password='" + request.getParameter("txt_password") + "' and guide_status='1'";

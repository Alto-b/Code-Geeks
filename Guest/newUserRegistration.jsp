...
<%
    if (request.getParameter("btn_submit") != null) {
        ...
        String InsQry = "insert into tbl_user(user_name,user_email,user_photo,user_password)"
                + "values('" + request.getParameter("txt_name") + "','" + request.getParameter("txt_email") + "',"
                + "'" + request.getParameter("txt_file") + "','" + request.getParameter("txt_password") + "')";

                        ...
                        <div class="nav-drop is-account-dropdown">
                            <div class="inner">
                                ...
                                <div class="nav-drop-body account-items">
                                    <a id="profile-link" href="SettingsM.jsp" class="account-item">
                                        <div class="media">
                ...
                <div class="sub-nav-tabs">
                    <div class="tabs is-centered">
                        <ul>
                            ...
                            <li>
                                <a href="MySubscriptionsM.jsp">My subscriptions</a>
                            </li>
                            <li>
                        ...
                        <div class="grid-header">
                            <div class="header-inner">
                                ...
                                <div class="header-actions">
                                    <div class="buttons">
                                        <a href="QuestionsM.jsp" class="button is-solid accent-button raised" >Need help?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        //                        
                            ...
                            <div class="column is-3">
                                <article class="group-box">
                                    ...
                                    <a href="SubscriptionDetailsM.jsp?subid=<%=rs.getString("sub_id")%>" class="box-link">

...
<html lang="en">
    ...
    <jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
        ...
        <%
            ...
            { 
        String up="update tbl_subsbooking set booking_status=1 where booking_id='"+request.getParameter("bid")+"'";
        System.out.print(up);
        if(con.executeCommand(up))
        {
            %>
            <script>
            window.location="HomePageM.jsp";</script>
                                                        ...
                                                        <div class="nav-drop-body is-friend-requests">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/bobby.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                                    <a href="#">Dan Walker</a>
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/nelly.png" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/milly.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/elise.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/edward.jpeg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="nav-drop-body is-notifications">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/david.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/daniel.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/stella.jpg" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="nav-drop-body is-friend-requests">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/nelly.png" data-user-popover="9" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/edward.jpeg" data-user-popover="5" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                            ...
                                                            <div class="media">
                                                                <figure class="media-left">
                                                                    <p class="image">
                                                                        <img src="https://via.placeholder.com/150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" data-user-popover="1" alt="">
                                                                    </p>
                                                                </figure>
                                                                <div class="media-content">
                                                                    <a href="#">Dan Walker</a>
...
<!--            <div class="navbar-item has-dropdown">
    ...
    <div class="view-wrapper">
        ...
        <div class="shop-wrapper">
                ...
                <div class="cart-header">
                    <div class="header-inner">
                        ...
                        <div class="header-actions">
                            <div class="buttons">
                                <a href="ViewSubscriptions.jsp" class="button is-light">
            ...
            <div id="payment-container" class="checkout-container">
                ...
                <div class="left">
                    <div class="left-header">
                        <div class="header-inner">
                            <img class="avatar" src="../Assets/Template/friendkit/assets/img/icons/logos/store.svg" alt="image">
                            <div class="separator"></div>
                            <div class="title-wrap">
                                <h3 class="payment-title">Pay your order</h3>
                                <p class="payment-subtitle">Enter your payment information</p>
                            </div>
                        </div>
                        <!--                        <div class="header-coupon">
                                                    <div class="field is-grouped">
                                                        <div class="control">
                                                            <input type="text" class="input" placeholder="Gift card or discount code" />
                                                        </div>
                                                        <div class="control">
                                                            <button class="button is-solid primary-button raised">Apply</button>
                                                        </div>
                                                    </div>
                        ...
                        <div class="header-foot">
                            ...
                            <%
                                String selQry="select * from tbl_subsbooking where booking_id='"+request.getParameter("bid")+"'";
                                ResultSet rs=con.selectCommand(selQry);
                                if(rs.next())
                                {
                            %>
                            <span class="amount" data-currency="INR"><%=rs.getString("booking_amount")%></span>
                            <%
                                    }
                            %>
                        </div>
                ...
                <div class="right">
                    <div class="payment-form">
                        <form action="/charge" method="get" id="stripe-payment-form" class="provider-form is-active">
                            <div id="checkout-contact-section" class="form-section has-margin-bottom">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="text" placeholder="Enter your email address" name="checkout_email" autofocus>
                                    </div>
                            ...
                            <div id="checkout-payment-section" class="form-section">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" placeholder="Enter the name on the card" name="checkout_name">
                                    </div>
                                </div>
                            ...
                            <div class="field is-disclaimer">
                                <p>By clicking on 'Confirm Payment', you confirm that you fully agree to our <a href="#">Terms Of
                                        Service</a> and to our <a href="#">Customer's Policy</a>.</p>
                            </div>

                            <div class="field is-button">
                                <div class="buttons has-addons">
                                    <button id="" type="submit" name="btn_save" value="save" class="button is-solid primary-button">Confirm
                                        Payment</button>
                                    <button type="button" class="button is-solid primary-button"> <span class="amount" data-currency="INR"></span></button>
                                </div>
                            </div>
            ...
            <div id="confirmation-container" class="checkout-container is-hidden">
                ...
                <div class="confirmation-box">
                    ...
                    <p>Thank you for your purchase. We will immediately make the subscription available for you. </p>
                    ...
                    <div class="order-summary">
                        ...
                        <div class="order-line">
                            ...
                            <div class="amount">
                                <span data-currency="INR"><%=rs.getString("booking_amount")%></span>
                            </div>
                        </div>
                        <div class="order-line">
                            <div class="item">
                            ...
                            <div class="amount">
                                <span data-currency="INR">0.0</span>
                            </div>
                        </div>
                        <div class="order-line">
                            <div class="item">
                            ...
                            <div class="amount">
                                <!--                                <span data-currency="USD">NIL</span>-->
                                <span>NIL</span>
                            </div>
                        </div>
                        <div class="order-line">
                    ...
                    <div align="center"><a href="PaymentM.jsp?bid=<%=request.getParameter("bid") %>&aid=1" class="button is-solid primary-button" >Done</a></div>done
                </div>
        ...
        <div class="chat-inner">
                ...
                <div class="nav-start">
                    <div class="recipient-block">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" alt="">
                        </div>
                        <div class="username">
            ...
            <div id="chat-sidebar" class="users-sidebar">
                ...
                <div class="header-item">
                    ...
                    <img class="dark-image" src="../Assets/Template/friendkit/assets/img/logo/friendkit-bold.svg" alt="">
                </div>
                <!-- User list -->
                <div class="conversations-list has-slimscroll-xs">
                    ...
                    <div class="user-item" data-chat-user="stella" data-full-name="Stella Bergmann" data-status="Busy">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/stella.jpg" alt="">
                    ...
                    <div class="user-item" data-chat-user="daniel" data-full-name="Daniel Wellington" data-status="Away">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/daniel.jpg" alt="">
                    ...
                    <div class="user-item" data-chat-user="david" data-full-name="David Kim" data-status="Busy">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/david.jpg" alt="">
                            <div class="user-status is-busy"></div>
                        </div>
                    </div>
                    <!-- User -->
                    <div class="user-item" data-chat-user="edward" data-full-name="Edward Mayers" data-status="Online">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/edward.jpeg" alt="">
                            <div class="user-status is-online"></div>
                        </div>
                    </div>
                    <!-- User -->
                    <div class="user-item" data-chat-user="elise" data-full-name="Elise Walker" data-status="Away">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/elise.jpg" alt="">
                            <div class="user-status is-away"></div>
                        </div>
                    </div>
                    <!-- User -->
                    <div class="user-item" data-chat-user="nelly" data-full-name="Nelly Schwartz" data-status="Busy">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/nelly.png" alt="">
                            <div class="user-status is-busy"></div>
                        </div>
                    </div>
                    <!-- User -->
                    <div class="user-item" data-chat-user="milly" data-full-name="Milly Augustine" data-status="Busy">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/milly.jpg" alt="">
                            <div class="user-status is-busy"></div>
                        </div>
                    </div>
                </div>
            ...
            <div id="chat-body" class="chat-body is-opened">
                ...
                <div id="dan-conversation" class="chat-body-inner has-slimscroll">
                    ...
                    <div class="chat-message is-sent">
                        <img src="https://via.placeholder.com/300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/jenna.png" alt="">
                        <div class="message-block">
                            <span>8:12am</span>

            ...
            <div class="inner is-scrollable">
                <div class="container">
                    <div class="questions-nav-menu">
                        <a href="HomePageM.jsp" class="menu-item">
                        ...
                        <a href="ViewBasicsM.jsp" class="menu-item">
                            <i data-feather="hexagon"></i>
                            <span>Basics</span>
                        </a>
                        <a href="ViewSubscriptionsM.jsp" class="menu-item">
                            <i data-feather="layers"></i>
                            <span>Subscriptions</span>
                        </a>
                        <a href="SettingsM.jsp" class="menu-item">
                            <i data-feather="settings"></i>
                            <span>Settings</span>
                        </a>
                    </div>
...
<!--                                <div class="control">
                    ...
                    <div class="columns true-dom is-hidden">
                        <div class="column">
                            <div class="categories-header">
                                <h2>Hola <%=rsu.getString("user_name")%> !</h2>
<!--                                <div class="control">
                                    <input class="input is-rounded" type="text" placeholder="Filter...">
                                    <div class="search-icon">
                                        <i data-feather="search"></i>
...
<!--homescreen options here-->
                            <div class="tile is-ancestor categories-tile-grid" style="background: white" >
            <div class="tile is-vertical is-8">
                <div class="tile">
                    <div class="tile is-parent is-vertical">
                        <a class="tile is-child category-box is-primary" href="CodeViewM.jsp">
                        ...
                        <a class="tile is-child category-box is-accent" href="ViewBasicsM.jsp">
                    ...
                    <div class="tile is-parent is-vertical">
                        <a class="tile is-child category-box is-accent" href="ViewSubscriptionsM.jsp">
                ...
                <div class="tile is-parent">
                    <a class="tile is-child category-box is-accent is-row" href="SettingsM.jsp">
            ...
            <div class="tile is-parent is-vertical">
                <a class="tile is-child category-box is-accent" href="MySubscriptionsM.jsp">
                ...
                <a class="tile is-child category-box is-primary" href="SChat/Chat.jsp">
                    <img src="../Assets/Template/friendkit/assets/img/illustrations/questions/gastronomy.svg" alt="">
                    <div class="box-content">
                ...
                <a class="tile is-child category-box is-primary" href="QuestionsM.jsp">

            ...
            <div class="sub-nav-tabs">
                <div class="tabs is-centered">
                    <ul>
                       ...
                       <li>
                           <a href="UserComplaint.jsp">Complaint</a>
                        </li>
                        <li>
                                        ...
                                        <div class="compose">
                                            <div class="compose-form">
                                                ...
                                                <div class="control">
                                                    ...
                                                    <textarea id="publish" name="txt_feedback" class="textarea" rows="3" placeholder="Share your feedbacks here...."></textarea>
...
<!--                                                <i data-feather="camera"></i>
                                        ...
                                        <div class="more-wrap">
                                            ...
                                            <button id="publish-button" type="button" class="button is-solid accent-button is-fullwidth is-disabled">
                                                ...
                                                <%
                                                String comsel="select * from tbl_feedback f inner join tbl_user u on u.user_id=f.user_id";
                            ...
                            <div class="card is-post is-simple">
                                ...
                                <div class="content-wrap">
                                    ...
                                    <div class="card-heading">
                                        ...
                                        <div class="user-block">
                                            ...
                                            <div class="user-info">
                                                ...
                                                <span class="time"><%=rcom.getString("feedback_date")%></span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Header -->
                                    ...
                                    <div class="card-body">
                                        <!-- Post body text -->
                                        <div class="post-text">
                                            <p><%=rcom.getString("feedback_content")%></p>
                                            <p>
                                        </div>
                                        <!-- Post actions -->

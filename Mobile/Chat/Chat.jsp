            ...
            <div class="chat-inner">
                ...
                <div class="chat-nav">
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="<%=rsu.getString("user_photo")%>"  alt="">
                            </div>
                            <div class="username">
                                <span><%=rsu.getString("user_name")%></span>
                    ...
                    <div class="nav-end">
                        ...
                        <a href="../HomePageM.jsp" class="chat-nav-item is-icon is-hidden-mobile">
                ...
                <div id="chat-sidebar" class="users-sidebar">
                    <!-- Header -->
                    <a href="../HomePageM.jsp" class="header-item">
                    ...
                    <div class="conversations-list has-slimscroll-xs">
                        ...
                        %>
                        <!-- User -->
<!--                        <a href="Chat.jsp?"><div class="user-item is-active" data-chat-user="dan" data-full-name="Dan Walker" 
                             <%
                             ...
                             %>>
                            <div class="avatar-container">
                                <img class="user-avatar" src="../../Assets/Files/GuidePhoto/<%=rsg.getString("guide_photo")%>"  alt="">

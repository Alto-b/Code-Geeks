    ...
    <body>
            ...
            <div class="sub-nav">
                <div class="sub-nav-tabs">
                    <div class="tabs is-centered">
                        <ul>
                            <li class="is-active">
                                <a href="HomePageM.jsp">Home</a>
                            </li>
                            <li>
                                <a href="ViewBasicsM.jsp">Basics</a>
                            </li>
                            <li>
                                <a href="ViewSubscriptionsM.jsp">Subscriptions</a>
                            </li>
                            <li>
                                <a href="UserFeedbackM.jsp">Feedback</a>
                            </li>
                            <li>
                                <a href="SettingsM.jsp">Profile</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        //                          
                            ...
                            <%//                        String selQry="select * from tbl_subs s inner join tbl_language l on s.sub_language=l.language_id inner join tbl_subsbooking b on b.sub_id=s.sub_id where user_id='"+session.getAttribute("uid")+"' ";
                                String selQry = "select * from tbl_subsbooking b inner join tbl_subs s on s.sub_id=b.sub_id inner join tbl_language l on l.language_id=s.sub_language where b.user_id='" + session.getAttribute("uid") + "' ";
       //                    out.println(selQry);

...
<html lang="en">
    ...
    <body>
                ...
                <div class="sub-nav-tabs">
                    <div class="tabs is-centered">
                        <ul>
                            ...
                            <li>
                                <a href="Chat/Chat.jsp">Community</a>
                            </li>
                            <li>
                        ...
                        <div class="grid-header">
                            <div class="header-inner">
                                ...
                                <div class="header-actions">
                                    <div class="buttons">
                                        <a href="#" class="button is-solid accent-button raised">Need help?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        //                          
                            ...
                            <%//                        String selQry="select * from tbl_subs s inner join tbl_language l on s.sub_language=l.language_id inner join tbl_subsbooking b on b.sub_id=s.sub_id where user_id='"+session.getAttribute("uid")+"' ";
                                String selQry = "select * from tbl_subsbooking b inner join tbl_subs s on s.sub_id=b.sub_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_language l on l.language_id=s.sub_language where b.guide_id='" + session.getAttribute("gid") + "' ";
       //                    out.println(selQry);
                                ...
                                <article class="group-box">
                                    <div class="box-info-hover">
                                        ...
                                        <div class="box-clock-info">
                                            ...
                                            <span class="box-time"><a href="query.jsp">need help?</a></span>
                                        </div>
                                    ...
                                    <a href="SubscriptionDetails.jsp?sid=<%=rs.getString("sub_id")%>" class="box-link">
                                    ...
                                    <div class="box-info">
                                        ...
                                        <h3 class="box-title"><%=rs.getString("sub_date")%></h3>
                                        <h3 class="box-title" style="color:#3333ff">Subscriber : <%=rs.getString("user_name")%></h3>

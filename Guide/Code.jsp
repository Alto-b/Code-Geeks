...
<html lang="en">
    ...
    <jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
        <head>
            ...
            <title> CODEGEEKS | GUIDE</title>
            <link rel="icon" type="image" href="../Assets/Files/Posters/0f8b2870896edcde8f6149fe2733faaf.jpg" />
    ...
    <body>
        ...
        <div class="navbar-v2">
            <div class="top-nav">
                <div class="left">
                    <div class="brand">
                        <a href="GuideDashboard.jsp" class="navbar-logo">
                                ...
                                <div class="nav-drop-body account-items">
                                    <a id="profile-link" href="GuideDashboard.jsp" class="account-item">
                                        <div class="media">
                                            ...
                                            <div class="media-content">
                                                <h3><%=rsg.getString("guide_name")%></h3>
            ...
            <div class="sub-nav">
                <div class="sub-nav-tabs">
                    <div class="tabs is-centered">
                        <ul>
                            <li class="is-active">
                                <a href="GuideDashboard.jsp">Home</a>
                            </li>
                            <li>
                                <a href="CodeList.jsp?cid=">Codes</a>
                            </li>
                            <li>
                                <a href="ActiveSubs.jsp">Subscriptions</a>
                            </li>
                            <li>
                                <a href="GuideSettings.jsp">Profile</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="view-wrapper">
            ...
            <div id="groups" class="navbar-v2-wrapper">
                ...
                <div class="container">
                    <div class="newcode">
                        <h1 align="center" style="margin-bottom: 20px;margin-bottom: 20px;
    font-size: 25px;">Start with your code</h1>
                        <form method="post">
                            <table align="center">
                                <tr>
                                    <td>
                                        <label>Language :</label>
                                        <select name="list_language" style="
                                                padding: 2px;
                                                font-size: 14px;
                                ...
                                <tr>
                                    <td>
                                        Title:
                                        <input type="text" name="txt_title" style="    width: 382px;
                                               height: 35px;
                                               padding: 10px;
                                               font-size: 16px;
                                               border: 1px solid #ccc;
                                    ...
                                    <td>
                                        <input type="submit" name="btn_submit" style="margin-left: -52px;margin-top: 7px;border-radius: 20px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <textarea id="myTextarea" name="txt_content" style="height: 400px; width: 300px;"></textarea>
                                    </td>
                                </tr>        
                                <!--                                <tr>
                                                                    <td>
                                        ...
                                        <div class="columns is-multiline">
                                                ...
                                                <article class="group-box">
                                                    <div class="box-info-hover">
                                                        ...
                                                        <div class="box-clock-info">
                                                            ...
                                                            <span class="box-time">11 new</span>
                                                        </div>
                    
                                                    </div>
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/1.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/1.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        <span class="box-category">Gaming</span>
                                                        <h3 class="box-title">The family gamers community</h3>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/2.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/2.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        ...
                                                        <span class="box-members">
                                                            ...
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/elise.jpg" data-user-popover="6" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/daniel.jpg" data-user-popover="3" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" data-user-popover="1" alt="">
                                                            </div>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/3.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/3.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        ...
                                                        <span class="box-members">
                                                            ...
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/nelly.png" data-user-popover="9" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/stella.jpg" data-user-popover="2" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/jenna.png" data-user-popover="0" alt="">
                                                            </div>
                                                        </span>
                                                    </div>
                                                </article>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/4.jpg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/4.jpg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        <span class="box-category">Fashion</span>
                                                        ...
                                                        <span class="box-members">
                                                            ...
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/rolf.jpg" data-user-popover="13" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/bobby.jpg" data-user-popover="8" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/mike.jpg" data-user-popover="17" alt="">
                                                            </div>
                                                        </span>
                                                    </div>
                                                </article>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/5.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/5.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        ...
                                                        <span class="box-members">
                                                            ...
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/jenna.png" data-user-popover="0" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/david.jpg" data-user-popover="4" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/edward.jpeg" data-user-popover="5" alt="">
                                                            </div>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/6.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/6.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/7.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/7.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/8.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/8.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/9.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/9.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        <span class="box-category">Food</span>
                                                        ...
                                                        <span class="box-members">
                                                            ...
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/rolf.jpg" data-user-popover="13" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/ken.jpg" data-user-popover="14" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/bobby.jpg" data-user-popover="8" alt="">
                                                            </div>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/10.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/10.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/11.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/11.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/12.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/12.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        <span class="box-category">Music</span>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/13.jpg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/13.jpg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        ...
                                                        <span class="box-members">
                                                            <a href="#">112.6k members</a>
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" data-user-popover="0" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/elise.jpg" data-user-popover="6" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/mike.jpg" data-user-popover="14" alt="">
                                                            </div>
                                                        </span>
                                                    </div>
                                                </article>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/14.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/14.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/15.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/15.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/16.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/16.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        <span class="box-category">Books</span>
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/17.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/17.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/18.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/18.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/19.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/19.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                            ...
                                            <div class="column is-3">
                                                <article class="group-box">
                                                    ...
                                                    <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/20.jpeg"></div>
                                                    <a href="#" class="box-link">
                                                        <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="../Assets/Template/friendkit/assets/img/demo/groups/20.jpeg"></div>
                                                    </a>
                                                    <div class="box-info">
                                                        <span class="box-category">Art</span>
                                                        ...
                                                        <span class="box-members">
                                                            ...
                                                            <div class="members-preview">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/daniel.jpg" data-user-popover="5" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/stella.jpg" data-user-popover="2" alt="">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/jenna.png" data-user-popover="0" alt="">
                                                            </div>
                                                        </span>

...
<html lang="en">
    ...
    <jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
        ...
        <%
            String selu = "select * from tbl_guide where  guide_id='" + session.getAttribute("gid") + "'";
    ...
    <body class="is-white">
                                                                ...
                                                                <div class="media">
                                                                    ...
                                                                    <div class="media-right">
                                                                        <button class="button icon-button is-solid grey-button raised">
                                                                            <i data-feather="guide-plus"></i>
                                                                        </button>
                                                                        <button class="button icon-button is-solid grey-button raised">
                                                                            <i data-feather="guide-minus"></i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                                 Friend request 
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="nav-drop-body is-friend-requests">
                                                                ...
                                                                <div class="media">
                                                                    <figure class="media-left">
                                                                        <p class="image">
                                                                            <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/nelly.png" data-guide-popover="9" alt="">
                                                                        </p>
                                                                    </figure>
                                                                    <div class="media-content">
                                                                ...
                                                                <div class="media">
                                                                    <figure class="media-left">
                                                                        <p class="image">
                                                                            <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/edward.jpeg" data-guide-popover="5" alt="">
                                                                        </p>
                                                                    </figure>
                                                                    <div class="media-content">
                                                                ...
                                                                <div class="media">
                                                                    <figure class="media-left">
                                                                        <p class="image">
                                                                            <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" data-guide-popover="1" alt="">
                                                                        </p>
                                                                    </figure>
                                                                    <div class="media-content">
                                                                        <a href="#">Dan Walker</a>
                    ...
                    <div class="navbar-end">
                        ...
                        <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                            <div class="guide-image">
                                <img src="<%=rsu.getString("guide_photo")%>" alt="">
                                <span class="indicator"></span>
                            </div>
                            ...
                            <div class="nav-drop is-account-dropdown">
                                <div class="inner">
                                    <div class="nav-drop-header">
                                        <span class="guidename">visibility mode</span>
                                    ...
                                    <div class="nav-drop-body account-items">
                                        <a id="profile-link" href="GuideSettings.jsp" class="account-item">
                                            <div class="media">
                                                ...
                                                <div class="media-content">
                                                    <h3><%=rsu.getString("guide_name")%></h3>
                ...
                <div class="navbar-item has-dropdown is-active">
                    ...
                    <div class="navbar-dropdown">
                        ...
                        <a href="/navbar-v1-profile-main.html" class="navbar-item is-flex is-mobile-icon">
                            <!--<span><i data-feather="guide"></i>Profile</span>-->
                        </a>
                ...
                <div class="inner is-scrollable">
                    <div class="container">
                        <div class="questions-nav-menu">
                            <a href="GuideDashboard.jsp" class="menu-item">
                            ...
                            <a href="CodeList.jsp?cid=" class="menu-item">
                                <i data-feather="hexagon"></i>
                                <span>Codes</span>
                            </a>
                            <a href="ActiveSubs.jsp" class="menu-item">
                                <i data-feather="layers"></i>
                                <span>Subscriptions</span>
                            </a>
                            <a href="GuideSettings.jsp" class="menu-item">
                                <i data-feather="settings"></i>
                                <span>Settings</span>
                            </a>
                        </div>
                    ...
                    <div class="container-inner" >
                        ...
                        <a class="story" onclick="getTut('cstart')">
                            <div class="story-avatar">
                                <img class="avatar" src="../Assets/Files/LangLogo/C.png"  data-guide-popover="1" alt="">
                        ...
                        <a onclick="getTut('cppstart')" class="story">
                            <div class="story-avatar">
                                <img class="avatar" src="../Assets/Files/LangLogo/cpp.png"  data-guide-popover="1" alt="">
                        ...
                        <a onclick="getTut('mysqlstart')" class="story">
                            <div class="story-avatar">
                                <img class="avatar" src="../Assets/Files/LangLogo/mysql.png"  data-guide-popover="1" alt="">
                        ...
                        <a onclick="getTut('htmlstart')" class="story">
                            <div class="story-avatar">
                                <img class="avatar" src="../Assets/Files/LangLogo/HTML.png"  data-guide-popover="1" alt="">
                        ...
                        <a onclick="getTut('javastart')" class="story">
                            <div class="story-avatar">
                                <img class="avatar" src="../Assets/Files/LangLogo/java.png"  data-guide-popover="1" alt="">
                            ...
                            <div class="question-content" id="tutContent">
                                ...
                                <div class="question-block" >
                                    ...
                                    <!--                                <div class="question-author">
                                                                        <img src="https://via.placeholder.com/150x150" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/milly.jpg" data-guide-popover="7" alt="">
                                                                        <div class="meta">
        ...
        <div class="chat-wrapper">
            <div class="chat-inner">
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" alt="">
                            </div>
                            <div class="guidename">
                        ...
                        <div class="dropdown is-spaced is-neutral is-right dropdown-trigger">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <div class="dropdown-content">
                                    ...
                                    <a class="dropdown-item">
                                        <div class="media">
                                            <i data-feather="guides"></i>
                                            <div class="media-content">
                                                <h3>Users</h3>
                                                <small>View all guides you're talking to.</small>
                                            </div>
                                        </div>
                                    </a>
                                    <hr class="dropdown-divider">
                ...
                <!-- Chat sidebar -->
                <div id="chat-sidebar" class="guides-sidebar">
                    <!-- Header -->
                    ...
                    <div class="conversations-list has-slimscroll-xs">
                        <!-- User -->
                        <div class="guide-item is-active" data-chat-guide="dan" data-full-name="Dan Walker" data-status="Online">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/dan.jpg" alt="">
                                <div class="guide-status is-online"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="stella" data-full-name="Stella Bergmann" data-status="Busy">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/stella.jpg" alt="">
                                <div class="guide-status is-busy"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="daniel" data-full-name="Daniel Wellington" data-status="Away">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/daniel.jpg" alt="">
                                <div class="guide-status is-away"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="david" data-full-name="David Kim" data-status="Busy">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/david.jpg" alt="">
                                <div class="guide-status is-busy"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="edward" data-full-name="Edward Mayers" data-status="Online">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/edward.jpeg" alt="">
                                <div class="guide-status is-online"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="elise" data-full-name="Elise Walker" data-status="Away">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/elise.jpg" alt="">
                                <div class="guide-status is-away"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="nelly" data-full-name="Nelly Schwartz" data-status="Busy">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/nelly.png" alt="">
                                <div class="guide-status is-busy"></div>
                            </div>
                        </div>
                        <!-- User -->
                        <div class="guide-item" data-chat-guide="milly" data-full-name="Milly Augustine" data-status="Busy">
                            <div class="avatar-container">
                                <img class="guide-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/milly.jpg" alt="">
                                <div class="guide-status is-busy"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="footer-item">
                        <div class="add-button modal-trigger" data-modal="add-conversation-modal"><i data-feather="guide"></i></div>
                    </div>
                </div>
                ...
                <div id="chat-panel" class="chat-panel is-opened">
                    <div class="panel-inner">
                        ...
                        <!-- Dan details -->
                        <div id="dan-details" class="panel-body is-guide-details">
                            <div class="panel-body-inner">
                                            ...
                                            <div class="dropdown-content">
                                                <a href="#" class="dropdown-item">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-content">
                                                            <h3>View profile</h3>
                                                            <small>View this guide's profile.</small>
                                                        </div>
                                                    </div>
                                                </a>
                                                <a class="dropdown-item">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-content">
                                                            <h3>Send message</h3>
                                                            <small>Send a message to the guide's inbox.</small>
                                                        </div>
                                                    </div>
                                                </a>
                                                <hr class="dropdown-divider">
                                                <a class="dropdown-item">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-content">
                                                            <h3>Share profile</h3>
                                                            <small>Share this guide's profile.</small>
                                                        </div>
                                                    </div>
                                                </a>
                                                <a class="dropdown-item">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-content">
                                                            <h3>Block guide</h3>
                                                            <small>Block this guide permanently.</small>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <div class="guide-meta has-text-centered">
                                    <h3>Dan Walker</h3>
                                    <h4>IOS Developer</h4>
                                </div>
                        ...
                        <!-- Stella details -->
                        <div id="stella-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                        ...
                        <!-- Daniel details -->
                        <div id="daniel-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                        ...
                        <!-- David details -->
                        <div id="david-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                        ...
                        <!-- Edward details -->
                        <div id="edward-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                        ...
                        <!-- Elise details -->
                        <div id="elise-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                        ...
                        <!-- Nelly details -->
                        <div id="nelly-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                        ...
                        <!-- Milly details -->
                        <div id="milly-details" class="panel-body is-guide-details is-hidden">
                            <div class="panel-body-inner">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="field is-autocomplete">
                            <div class="control has-icon">
                                <input type="text" class="input simple-guides-autocpl" placeholder="Search a guide">
                                <div class="form-icon">
                                    <i data-feather="search"></i>
                                </div>
                            </div>
                        ...
                        <div class="help-text">
                            Select a guide to start a new conversation. You'll be able to add other guides later.
                        </div>
        ...
        <script src="../Assets/Template/friendkit/assets/js/popovers-guides.js"></script>

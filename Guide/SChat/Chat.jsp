...
%>
 <%
                            String selgu = "select * from tbl_user g inner join tbl_subsbooking s on g.user_id=s.user_id where s.guide_id='" + session.getAttribute("gid") + "'";
            ...
            <div class="chat-wrapper is-standalone">
                <div class="chat-inner">
                        ...
                        <div class="nav-start">
                            <div class="recipient-block">
                                <div class="avatar-container">
                                    <img class="user-avatar" src="<%=rsgu.getString("user_photo")%>" alt="">
                                </div>
                                <div class="username">
                                    <span><%=rsgu.getString("user_name")%></span>
                    ...
                    <div id="chat-sidebar" class="users-sidebar">
                        ...
                        <%
                            String selg = "select * from tbl_user g inner join tbl_subsbooking s on g.user_id=s.user_id where s.guide_id='" + session.getAttribute("gid") + "'";
                            ResultSet rsg = con.selectCommand(selg);
                            while (rsg.next()) {

                        %>
                        <!-- User -->
                        <a href="Chat.jsp?uid=<%=rsg.getString("user_id")%>"><div class="user-item is-active" data-chat-user="dan" data-full-name="Dan Walker" 
                                                                                  <%
                                                                                  ...
                                                                                  %>>
                                <div class="avatar-container">
                                    <img class="user-avatar" src="<%=rsg.getString("user_photo")%>"  alt="">
                        ...
                        %>
                        <input type="hidden" id="txthid" value="<%=request.getParameter("uid")%>">
                        <!-- User -->
        ...
        <script>
                                    ...
                                    function sendChat()
                                    {
                                        ...
                                        {
                                            alert("Character Length less Than 100 Allowed");
                                            document.getElementById("msg").value = "";

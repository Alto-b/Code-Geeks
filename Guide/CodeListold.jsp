            ...
            <div class="container is-fluid">
                <div class="navbar-brand">
                    <a href="/" class="navbar-item">
                        <img class="logo light-image" src="../Assets/Template/friendkit/assets/img/logo/friendkit-bold.svg" width="112" height="28" alt="">
                        <img class="logo dark-image" src="../Assets/Template/friendkit/assets/img/logo/friendkit-white.svg" width="112" height="28" alt="">
                    </a>
                </div>
...
<!--                            <div class="shopping-cart">
                        ...
                        <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                            <div class="user-image">
                                <img src="https://via.placeholder.com/400x400" data-demo-src="../Assets/Template/friendkit/assets/img/avatars/jenna.png" alt="">
                                <span class="indicator"></span>
                            </div>
                ...
                <div class="cart-container">
                    <div class="cart-header">
                        <div class="header-inner">
                            <h2 id="checkout-step-title">Select the code</h2>
                            ...
                            <div class="header-actions">
                                <div class="buttons">
                                    <a id="checkout-back" class="button is-light" data-step="0" href="HomePage.jsp">
                        ...
                        <div class="columns">
                                ...
                                <div id="checkout-section-1" class="checkout-section is-active">
                                    ...
                                    <div class="flex-table" >
                                        ...
                                        <div class="flex-table-header">
                                            ...
                                            <!--<span class="discount">Edit</span>-->

                                        </div>
                                        <!--Table item-->
                                        <%
                                            String sel = "select * from tbl_code c inner join tbl_language l on c.language_id=l.language_id  ";
                                        ...
                                        <!--                                    <div class="flex-table-item">
                                                                                <div class="product">
                                                                                    <img src="../Assets/Template/friendkit/assets/img/products/3.svg" alt="">
                                                                                    <span class="product-name">Military Short</span>
                                                                                </div>
                                                                                <div class="quantity">
                                                                                    <span class="has-price">1</span>
                                                                                </div>
                                                                                <div class="price">
                                                                                    <span class="has-price">39.00</span>
                                                                                </div>
                                                                                <div class="discount">
                                                                            ...
                                                                            <div class="flex-table-item">
                                                                                <div class="product">
                                                                                    <img src="../Assets/Template/friendkit/assets/img/products/4.svg" alt="">
                                                                                    <span class="product-name">Cool Backpack</span>
                                                                                </div>
                                                                                <div class="quantity">
                                                                                    <span class="has-price">1</span>
                                                                                </div>
                                                                                <div class="price">
                                                                                    <span class="has-price">125.00</span>
                                                                                </div>
                                                                                <div class="discount">
                                                                                    <span class="has-price">0</span>
                                                                                </div>
                                    ...
                                    <!--                        <div class="column is-4">
                                                                <div class="cart-summary">
                                                                    ...
                                                                    <div id="shipping-placeholder-box" class="summary-card has-text-centered">
                                                                        <img class="light-image" src="../Assets/Template/friendkit/assets/img/icons/questions/cart.svg" alt="">
                                                                        <img class="dark-image" src="../Assets/Template/friendkit/assets/img/icons/questions/cart-dark.svg" alt="">
                                                                        <h4>Shipping</h4>
                                                                        <p>Please verify your order before proceeding with shipping.</p>
                                                                    </div>
                                    
                                                                    card
                                                                    <div id="shipping-address-box" class="summary-card is-hidden">
                                                                        <img class="light-image shipping-logo" src="../Assets/Template/friendkit/assets/img/icons/checkout/world.svg" alt="">
                                                                        <img class="dark-image shipping-logo" src="../Assets/Template/friendkit/assets/img/icons/checkout/world-dark.svg" alt="">
                                                                    ...
                                                                    <div class="summary-card">
                                                                        ...
                                                                        <div id="total-amount" class="order-line">
                                                                            ...
                                                                            <span class="is-total">201.92</span>
                                                                        </div>
                                                                        <div class="button-wrap">
                                                                            <button id="checkout-button" class="button is-solid primary-button raised is-fullwidth" data-step="2">Continue</button>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="column is-8">
                                ...
                                <form method="post"> 
                                    ...
                                    <textarea name="txt_code" rows="30" cols="70" >
                                        <%=rs1.getString("code_content")%>
                                    </textarea>      
                                    <input type="submit" name="btn_update" value="update">
                                    <input type="button" name="btn_delete" value="delete"> 
                                </form>
                                <%
                                    }
                                %>

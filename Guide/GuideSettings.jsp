...
<head>
    ...
    <%
            ...
            { 
                ...
                String upQry="update tbl_guide set guide_name='"+request.getParameter("txt_name")+"', guide_email='"+request.getParameter("txt_email")+"' where guide_id='"+session.getAttribute("gid")+"'";
                // out.print(upQry);
     ...
     <%
            ...
            String sel1="select * from tbl_guide where guide_id='"+session.getAttribute("gid")+"'";
         
            ResultSet rs1=con.selectCommand(sel1);
            rs1.next();
            
            
          if(rs1.getString("guide_password").equals(request.getParameter("opass")))
          {
              ...
              else
              {
                  ...
                  <script>
                      ...
                      window.location="GuideSettings.jsp";
                  </script>
                  <%
              }
          }
                                ...
                                <div class="column is-6">
                                    ...
                                    <div class="field field-group">
                                        ...
                                        <div class="control has-icon">
                                            <input type="text" class="input is-fade" name="txt_name" value="<%=rs.getString("guide_name")%>" required>
                                            <div class="form-icon">
                                                <i data-feather="user"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="field field-group">
                                            <label>Email</label>
                                        <div class="control has-icon">
                                            <input type="text" class="input is-fade" name="txt_email" value="<%=rs.getString("guide_email")%>" required>
                                            <div class="form-icon">
                                                <i data-feather="mail"></i>
                                            </div>
                                        </div>
                            ...
                            <img class="dark-image" src="../Assets/Template/friendkit/assets/img/illustrations/settings/1-dark.svg" alt="">
                             <%
                                        ...
                                        while (rs1.next()) {
                                            ...
                                            String selQry = "select * from tbl_guide_language where language_id='" + rs1.getString("language_id") + "' and guide_id='" + session.getAttribute("gid") + "'";
                                            ResultSet rs2 = con.selectCommand(selQry);
                                            if (rs2.next()) {
                                    %>
                                    <input type="checkbox" name="lang" checked="" onclick="insLang(<%=rs1.getString("language_id")%>, 'false')"><%=rs1.getString("language_name")%><br>
                                    <%
                                    } else {
                                    %>
                                    <input type="checkbox" name="lang" onclick="insLang(<%=rs1.getString("language_id")%>, 'true')"><%=rs1.getString("language_name")%><br>
                                    <%
                                            }
                                        }
                                    %>
                        ...
                        <div class="settings-form">
                            <div class="columns is-multiline flex-portrait">
                                ...
                                <div class="column is-4">
                                    <a class="setting-sublink" href="GuideSettings.jsp">
                                ...
                                <!--link-->
                                <div class="column is-4">
                                    <a class="setting-sublink" href="ActiveSubs.jsp">
                                        <div class="link-content">
                                            <div class="link-icon">
...
<!--                                
                                link
                                <div class="column is-4">
                                    <a class="setting-sublink" href="UserFeedback.jsp">
                                        <div class="link-content">
                                            <div class="link-icon">
                                 ...
                                 link
                                <div class="column is-4">
                                    <a class="setting-sublink" href="UserComplaint.jsp">
                                        <div class="link-content">
                                            <div class="link-icon">

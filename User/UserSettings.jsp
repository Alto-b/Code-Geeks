                                ...
                                <div class="column is-6">
                                    ...
                                    <div class="field field-group">
                                        ...
                                        <div class="control has-icon">
                                            <input type="text" class="input is-fade" name="txt_name" value="<%=rs.getString("user_name")%>" required>
                                            <div class="form-icon">
                                                <i data-feather="user"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="field field-group">
                                            <label>Email</label>
                                        <div class="control has-icon">
                                            <input type="text" class="input is-fade" name="txt_email" value="<%=rs.getString("user_email")%>" required>
                                            <div class="form-icon">
                                                <i data-feather="mail"></i>
                                            </div>
                                        </div>
                        ...
                        <div class="settings-form">
                            <div class="columns is-multiline flex-portrait">
                                ...
                                <div class="column is-4">
                                    <a class="setting-sublink" href="UserSettings.jsp">
                                ...
                                <!--link-->
                                <div class="column is-4">
                                    <a class="setting-sublink" href="MySubscriptions.jsp">
                                        <div class="link-content">
                                            <div class="link-icon">

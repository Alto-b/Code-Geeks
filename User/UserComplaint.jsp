 ...
 <!--queries start-->
        ...
        <!--queries end-->
         <%
            ...
            {
                String selc="insert into tbl_complaint (complaint_content,complaint_date,user_id) values ('"+request.getParameter("txt_complaint")+"',curdate(),'"+session.getAttribute("uid")+"')";
                                       ...
                                       <form method="POST">
                                        <div class="compose">
                                            <div class="compose-form">
                                                ...
                                                <div class="control">
                                                    ...
                                                    <textarea id="publish" name="txt_complaint" class="textarea" rows="3" placeholder="Tell us about where should we improve..."></textarea>
                                        ...
                                        <div id="basic-options" class="compose-options">
                                            ...
                                            <div class="compose-option">
                                                <input type="submit" name="btn_submit" value="btn_submit">
...
<!--                                                <i data-feather="camera"></i>
                                        ...
                                        <div class="more-wrap">
                                            ...
                                            <button id="publish-button" type="button" class="button is-solid accent-button is-fullwidth is-disabled">
                                                ...
                                                <%
                                                String comsel="select * from tbl_complaint c inner join tbl_user u on c.user_id=u.user_id";
                                ...
                                <div class="content-wrap">
                                    ...
                                    <div class="card-heading">
                                        ...
                                        <div class="user-block">
                                            <div class="image">
                                                <!--<img src="../Assets/Files/UserPhoto/" data-user-popover="8" alt="">-->
                                            </div>
                                            <div class="user-info">
                                                <a href="#"><%=rcom.getString("complaint_content")%></a>
                                                <span class="time"><%=rcom.getString("complaint_date")%></span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Header -->
                                    ...
                                    <div class="card-body">
                                        <!-- Post body text -->
                                        <div class="post-text">
                                            <p><%=rcom.getString("complaint_reply")%></p>
                                            <p>
                                        </div>
                                        <!-- Post actions -->

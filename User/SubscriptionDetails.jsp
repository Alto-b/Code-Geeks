             ...
             if(request.getParameter("sid")!=null)
                         {
                          ...
                          if(con.executeCommand(insQry))
                          {
                             ...
                             response.sendRedirect("Payment.jsp?bid="+bid);
//                             edited
                          }
                         } 
    ...
    <!--                        <div class="info-block">
                    ...
                    <div class="right">
                        ...
                        <div class="subscribe-block">
                            ...
                            <a href="SubscriptionDetails.jsp?sid=<%=rs.getString("sub_id")%>&amt=<%=rs.getString("sub_amount")%>"  <button  class="button is-solid primary-button raised" name="btn_subscribe">Subscribe </button> </a>
                        </div>
